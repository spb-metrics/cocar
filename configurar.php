...
tp=30 // distância do topo do menu em relação a página 
lf=10 //distância da esquerda do menu em relação a página
sp=5 //espaço entre os menus
hr=1 //espaço horizontal (1 - horizontal | 0 - vertical)
oh=50 
ov=50

mn[0]='<B>Configura&ccedil;&otilde;es</B>';ln[0]='#';sw[0]=130;sn[0]="" // menu 
+q7+"Cadastro"+q6 
+q1+"cad_ent.html"+q1b+"principal"+q2+"Entidades"+q3+"&raquo;&nbsp;Entidades"+q4 
+q1+"cad_circ.html"+q1b+"principal"+q2+"Circuitos"+q3+"&raquo;&nbsp;Circuitos"+q4 
