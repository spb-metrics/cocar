...
error_reporting(0);
	...
	$aplicacao = "REDE DE ACESSO - Tráfego nos Circuitos - Vários dias";
?>
<HTML>
...
&nbsp;
        ...
        <select size="1" name="num_dias" style="font-family: Verdana; font-size: 11px; background-color: #FAF8EB;">
					<option selected value=<?php if($num_dias=="")$auxd=1; else $auxd=$num_dias; echo "'$num_dias'>$auxd</option>"; ?>
...
<b><font face="Verdana" size="3">+</font></b>        
        <select size="1" name="Iperiodo" style="font-family: Verdana; font-size: 11px; background-color: #FAF8EB;"">
					<option selected value=<?php if($Iperiodo=="")$aux3="Per"; else $aux3=$Iperiodo.":00"; echo "'$Iperiodo'>$aux3&nbsp;&nbsp;</option>"; ?>
...
if ($dia==$hoje){
    echo"<TR>
	    <table border='0' width='300' cellpadding='5' CLASS='tdi' BGCOLOR='#CCFFCC' ALIGN='center' HEIGHT='70'>
 		<BR><BR><BR>
		<TR><TD ALIGN='center' VALIGN='middle' ><FONT SIZE='+1'>Para o dia de hoje, $dia_tela, consulte: http://dipro-300/</FONT>
		</TD></TR>
        </table>
	";
	exit;	
...
// Display the graph
$nome_graf = "diario_varios/$circ" ."_" .  date('U') ."_" .$z. ".png";
...
$timeZ = $timeZ + 86400;
$dia   = date('Y-m-d ',$timeZ);
$data_hora_inicio 	= $dia.$h_inicio.":00:00";			
$data_hora_fim 		= $dia.$h_fim;
$dia_tela 	= date('d/m/Y',$timeZ);
$dia_graf 	=	Date('d/m/Y',$time);
$i=0;
}//primeiro for ($z=1; $z<= $num_dias; $z++)
